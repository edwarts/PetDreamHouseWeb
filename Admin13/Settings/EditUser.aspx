<%@ Page Title="Edit User" Language="VB" MasterPageFile="~/MasterPages/AdminSettings.master" AutoEventWireup="false" CodeFile="EditUser.aspx.vb" Inherits="Admin13_Settings_EditUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SubContentBody" Runat="Server">
    ...
    <div style="padding:10px;">
        <h3 id="h3Title" runat="server">Add User</h3>
        <br />
