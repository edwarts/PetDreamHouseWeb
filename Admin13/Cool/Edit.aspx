<%@ Page Title="Edit Cool Item" Language="VB" MasterPageFile="~/MasterPages/AdminCool.master" AutoEventWireup="false" CodeFile="Edit.aspx.vb" Inherits="Admin13_Concepts_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SubContentBody" Runat="Server">
    ...
    <div style="padding:10px;">
        <h3 id="h3Title" runat="server">Add New Cool Stuff</h3>
        <br />
            ...
            <asp:TabPanel ID="tabDetails" runat="server" HeaderText="Details">
                <ContentTemplate>
                    <div class="ProductEditor" style="padding:15px;">
                            ...
                            <b>Currently in Store</b>
                            <asp:CheckBox ID="cbxInStore" runat="server" />
                            <br /><br />

                            <b>What is it?</b>
                            <asp:TextBox ID="txtWhat" Width="400" TextMode="MultiLine" Rows="8" runat="server"></asp:TextBox>
                            <br /><br />

                            <b>Features</b>
                            <asp:TextBox ID="txtWhy" Width="400" TextMode="MultiLine" Rows="8" runat="server"></asp:TextBox>
                            <br /><br />
                            ...
                            <b>Submitted By</b>
                            <asp:TextBox ID="txtSubmitter" Width="200" runat="server"></asp:TextBox>
                            <br /><br />

                            <b>Submitter Email</b>
                            <asp:TextBox ID="txtSubmitterEmail" Width="200" runat="server"></asp:TextBox>
                            <br /><br />

                            <b>Site Name</b>
                            <asp:TextBox ID="txtSiteName" Width="200" runat="server"></asp:TextBox>
                            <br /><br />

                            <b>Site URL</b>
                            <asp:TextBox ID="txtSiteUrl" Width="200" runat="server"></asp:TextBox>
                            <br /><br />
